...
const NO_FMTP_SDP = ['v=0', 'm=audio 9 UDP/TLS/RTP/SAVPF 111', 'a=rtpmap:111 opus/48000/2'].join('\r\n');
...
describe('applyOpusPreferences', () => {
  ...
  it('麦克风 + 共享系统声音两条 opus m 段都被处理', () => {
    const dual =
      BASE_SDP.replace('m=video 9 UDP/TLS/RTP/SAVPF 96', 'm=audio 9 UDP/TLS/RTP/SAVPF 112') +

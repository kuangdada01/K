...
export default function AdminPage() {
  ...
  const [annSearchResults, setAnnSearchResults] = useState<
              ...
              <div className={styles.sendForm}>
                ...
                <div className={styles.annWrapper} ref={annDropdownRef}>
                  <div className={styles.annInputRow}>
                    ...
                    />
                    {annTargetId && (
                      <button className={styles.annClear} onClick={clearAnnTarget}>
                        ×
                      </button>
                    )}
                  </div>
                      ...
                      {annSearchResults.map((u) => (
                        <div key={u.id} className={styles.annItem} onClick={() => selectAnnTarget(u)}>
                          {u.avatar ? (
                            ...
                            <div className={styles.annAvatarPlaceholder}>
                ...
                <div className={styles.formActions}>
                  <button className={styles.confirmBtn} onClick={handleSendAnn}>
                    发送
                  </button>
        ...
        <div className={styles.modalOverlay} onClick={() => setBanTarget(null)}>
          <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
            ...
            <div className={styles.formActions} style={{ gap: 8 }}>
              <button className={styles.confirmBtn} onClick={() => handleBan(1)}>
                1天
              </button>
              <button className={styles.confirmBtn} onClick={() => handleBan(7)}>
                1周
              </button>
              <button className={styles.confirmBtn} onClick={() => handleBan(30)}>
                1月
              </button>
              <button className={styles.confirmBtn} onClick={() => handleBan(365)}>
                1年
              </button>
              <button className={styles.cancelBtn} onClick={() => setBanTarget(null)}>
                取消
              </button>
            </div>
          </div>
